...
/*
 * This class is a quick initial network creater, taken from the Matsim examples. Improvements to be added:
 * 		- Main road, smaller road distinction (keep highways of larger area)
 *      - Crop in this class using shapefile of Locarno area
 * 		- General usability for any network (by passing in arguments)
 */
public class CreateNetwork {
	...
	public static void main(String[] args) {
		 ...
		 * The input file name.
		 */
		String osm = "../../data/osm/locarno.osm";
		...
		CoordinateTransformation ct = 
			 TransformationFactory.getCoordinateTransformation(TransformationFactory.WGS84, TransformationFactory.CH1903_LV03_Plus);
		 ...
		 */
		new NetworkWriter(network).write("../../data/network/locarno_test.xml");
